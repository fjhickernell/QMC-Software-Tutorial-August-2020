...
The following code utilizes QMCPy's Asian option \texttt{Integrand} object to make a crude approximation of the payoff. The following section will describe stopping criterion useful to automatically determining $n$. 
