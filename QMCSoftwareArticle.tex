...
\begin{figure}
	\includegraphics[height=5cm]{ags/figs/iid_uniform_pts.png}%{ProgramsImages/IIDPoints.eps} 
	\qquad
	\includegraphics[height=5cm]{ags/figs/sobol_pts.png}%{ProgramsImages/SSobolPoints.eps}
...
\AGSComment{Reformatted the first bullet as an example. I can change the rest if this is what we want.}
...
% https://tex.stackexchange.com/questions/74279/how-to-add-bullets-to-description-lists
	\item[$\cdot$ BRODA:] Sobol' sequences in C, MATLAB, and Excel \cite{BRODA20a},
...
\end{multline}
This required four components, which we implement in QMCPy as classes: \AGSComment{... QMCPy as abstract classes that can be fleshed out into concrete implementations.}
...
\end{array}
\]
\AGSComment{Change to (t+x) mod 1?}
...
The first three generators for this lattice are $\bsZ_1 = (0.5, 0.5)$, $\bsZ_2 = (0.25, 0.75)$, and $\bsZ_4 = (0.125, 0.875)$.  One can check that $\bsZ_6 = (\bsZ_2 + \bsZ_4) \bmod \bsone = (0.375, 0.625)$.
...
\AGSComment{Do we want to list available classes? \\ Should we put examples for other discrete distrib objects? \\ $>>>$ ? \\ Talk about custom generating vectors / matrices?}

\begin{figure}
	\includegraphics[height=5cm]{ags/figs/dd_iid.png}
	\caption{\AGSComment{ToDO}} \label{fig:dd_iid}
\end{figure}
\begin{figure}
	\includegraphics[height=4cm]{ags/figs/dd_ld.png}
	\caption{\AGSComment{ToDO}} \label{fig:dd_ld}
\end{figure}
...
\begin{figure}
	\includegraphics[height=4cm]{ags/figs/tm1.png}
	\caption{\AGSComment{ToDO}} \label{fig:dd_ld}
\end{figure}
...
\begin{figure}
	\includegraphics[height=4cm]{ags/figs/i_keister_figs.png}
	\caption{\AGSComment{ToDO}} \label{fig:ikf}
\end{figure}

\begin{figure}
	\includegraphics[height=4cm]{ags/figs/i_keister_contours.png}
	\caption{\AGSComment{ToDO}} \label{fig:ikc}
\end{figure}

\section{Stopping Criteria}

\lstinputlisting[style=Python]{ags/python/stopping_criterion.py}
\AGSComment{show output?}



\section{Under the Hood}

\lstinputlisting[style=Python]{ags/python/under_the_hood_1.py}
