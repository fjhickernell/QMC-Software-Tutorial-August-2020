...
%	\quad
	...
	\caption{Sobol' samples transformed to mimic a 32-dimensional Brownian Motion. The figure on the left does not use importance sampling while the figure on the right uses importance sampling with drift $a=2$.}
	\label{fig:tm_bm}
\end{figure}
