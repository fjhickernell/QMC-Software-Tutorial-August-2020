...
% https://tex.stackexchange.com/questions/74279/how-to-add-bullets-to-description-lists
	...
	\item[LatNet Builder] Generating vectors/matrices for lattices and digital nets \cite{LatNet,\LEcEtal22a},
...
\lstinputlisting{ags/python/install.py} 
...
\lstinputlisting[style=Python]{ags/python/dd.lattice.py}
...
\lstinputlisting[style=Python]{ags/python/dd.sobol.py}
...
\lstinputlisting[style=Python]{ags/python/dd.iidone.py}
...
\lstinputlisting[style=Python]{ags/python/dd.latticeone.py}
...
\lstinputlisting[style=Python]{ags/python/dd.latticenextone.py}
...
\lstinputlisting[style=Python]{ags/python/tm.uniform.py}
for uniform points based on a Halton sequence, and 
\lstinputlisting[style=Python]{ags/python/tm.gaussian.py}
...
\lstinputlisting[style=Python]{ags/python/tm.brownian_motion.py}
...
\lstinputlisting[style=Python]{ags/python/i.keister.py}
...
\lstinputlisting[style=Python]{ags/python/i.keisterLebesgue.py}
...
Note that the Keister function has been also implemented as a concrete integrand class in the QMCPy library.  \FJHComment{Does the built in Keister function work like the Asian options does, meaning that the problem is the same no matter the distribution? }
...
\lstinputlisting[style=Python]{ags/python/i.aco.py}
\begin{figure}
...
\lstinputlisting[style=Python]{ags/python/sc.keister.qmc.py}
