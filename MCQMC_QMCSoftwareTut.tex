...
\begin{frame}{Where Is the Software?}
	...
	\begin{tabular}{>{\centering}m{0.47\textwidth}@{\qquad}>{\centering}m{0.47\textwidth}}
		...
		\uncover<1>{\href{https://www.mathworks.com}{\alert{MATLAB Statistics Toolbox}}---\\ Sobol' and Halton} &
...
\iffalse
QMC software at MCQMC 2020 this summer.  Besides my own team’s libraries, I am aware of and will try to mention
ALSVID-UQ http://www.sam.math.ethz.ch/alsvid-uq/ 
Mike Giles’s team’s MLMC software, https://people.maths.ox.ac.uk/gilesm/mlmc/
Stephen Joe and Frances Kuo’s Sobol’ direction numbers https://web.maths.unsw.edu.au/~fkuo/sobol/index.html 
The R package qrng from Christiane Lemieux’s team, https://cran.r-project.org/web/packages/qrng/qrng.pdf
Pierre L’Ecuyer’s team’s LatNet Builder and other software https://github.com/umontreal-simul/
Dirk Nuyen's Magic Point Shop https://people.cs.kuleuven.be/~dirk.nuyens/qmc-generators/

https://github.com/PieterjanRobbe/QMC.jl
\fi
...
\begin{frame}{Jupyter Notebooks on Colab}
	\begin{itemize}
