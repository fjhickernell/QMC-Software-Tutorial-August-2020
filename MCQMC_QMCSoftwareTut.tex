...
\begin{frame}{The Argument for Community Software}
	...
	\begin{itemize}
	\item<1-> Our research groups are typically expert at only part of the whole picture:
			\begin{itemize}
	...
	\item<2-> We provide a consistent interface for  different pieces from different places.
