...
\begin{frame}{What Software Components Do We Need?}
	...
	\[
	 \uncover<2->{\mu =  \int_{\ct} g(\vt) \, \lambda(\vt) \, \dif \vt = \cdots = } 	\underbrace{\Ex[f(\vX)]}_{\text{expectation}} = \underbrace{\int_\cx f(\vx) \, \varrho(\vx) \, \dif \vx}_{\text{integration}} \approx  \frac 1n \sum_{i=1}^n f(\vx_i) =: \hmu
	\]
