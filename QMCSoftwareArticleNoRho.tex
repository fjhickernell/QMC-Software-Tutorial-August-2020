...
% https://tex.stackexchange.com/questions/74279/how-to-add-bullets-to-description-lists
	\item[BRODA] Commerical and non-commercial software developed jointly with I.M.~Sobol in C++, MATLAB, and Excel~\cite{BRODA20a}, it can generate Sobol' sequences up to 65,536 dimensions. We note that, in comparison, the maximum dimension of Sobol sequences in QMCPy is 16,510.	
	...
	\item[Owen] Randomized Halton sequences with dimension up to 1,000 \cite{Owe20a} and scrambled Sobol' sequences with dimension up to 21,021  \cite{owen2021r, owen1998scrambling}  in R. QMCPy has implemented multiple Halton generators, one of which is Owen's randomized Halton algorithm.
