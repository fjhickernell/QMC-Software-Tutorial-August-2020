...
Out of the money option price calculations can be sped up by adding a drift to the Brownian motion that produces more in the money paths  \JRComment{Out of the money option price calculations: This statement is unclear}. This is a form of importance sampling.  Using a Brownian motion without drift we get
