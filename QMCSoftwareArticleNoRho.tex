...
\begin{description}[format=\textup,format=\textbf]
	...
	\item[Integrand] $g$  defines the original, and $f$ defines the transformed version to fit the discrete distribution; and
...
\begin{figure}
	...
	\caption{Right: Sampling the transformed integrand $f$ at Halton points $\bsx_i \LDsim \calU[0,1]^2$. Left: Sampling the original integrand $g$ at $\bsPsi(\bsx)$ where $\bsPsi$ is defined in \eqref{eq:exampleVarTransGauss}.  } \label{fig:ikc}
\end{figure}
