...
% https://tex.stackexchange.com/questions/74279/how-to-add-bullets-to-description-lists
	\item[SobolSeq] Commerical and non-commercial software developed by BRODA Limited and I.M.~Sobol, SobolSeq can generate Sobol' sequences up to 65,536 dimensions in C++, MATLAB, and Excel~\cite{BRODA20a}. \scnote{Not used in QMCPy (yet), right? What is the max dim of Sobol sequences in QMCPy?}
	...
	\item[QMC.jl] LD Sequences in Julia \cite{Rob20a}. Julia~\cite{bezanson2012julia} is a language similar to Python in terms of ease of use, but is designed to run much faster.
